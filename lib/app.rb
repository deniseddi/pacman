...
#                 # the PLACE command is really initialising the pacman
#                 # breaking up the input 
#                 x, y, f = parse_command(input)
#                 # if statement is now checking to make sure the first place 
...
#             #elsif statement here so user can exit the game without breaking the code
#             elsif input == 'exit'
#                 break
#             end
#         end
